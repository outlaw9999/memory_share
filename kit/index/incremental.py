...
class IncrementalIndexer:
    ...
    def index_incremental(self, root_path: str) -> None:
        ...
        # 2. Quét toàn bộ repo sử dụng Safe Walker để so sánh Hash
        to_index: List[Tuple[Path, str, str]] = []
        for full_path in safe_walk(root_path):
        ...
        for full_path, rel_path, f_hash in to_index:
            ...
            self.indexer.index_file(str(full_path), module_name)
