...
from ..core import AtlasIndexer
from ..core import Scanner
from ..core.exceptions import KitQueryError
...
class ApplicationService:
    ...
    def __init__(self, workspace_root: str | None = None) -> None:
        self.workspace_root = Path(
            workspace_root or os.environ.get("ANTIGRAVITY_WORKSPACE_ROOT", os.getcwd())
        )
    ...
    def index_codebase(self) -> str:
        ...
        try:
            ...
            conn.rollback()
            raise RuntimeError(f"Index failed: {e}") from e

        return f"Indexed {processed_count} files in {time.time() - start_time:.2f}s."

    def run_sql_stone(
        self, query_name: str, params: Any = None, timeout: int = 30
    ) -> Any:
        import sqlite3
        ...
        try:
            ...
            raise KitQueryError(f"Error executing SQL Stone '{query_name}': {e}") from e
