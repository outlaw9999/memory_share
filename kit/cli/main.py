...
BOOTSTRAP_FACTS: list[tuple[str, str]] = [
    ...
    ("kit_learn", "kit learn stores atomic memories"),
    ("kit_auto", "kit learn auto routes local and global memory"),
    ("kit_reflect", "kit reflect checks drift before risky changes"),
