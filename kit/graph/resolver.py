...
class ModuleFunctionResolver:
    ...
    STDLIB = frozenset({
        ...
        'itertools', 'functools', 'operator', 'pathlib', 'abc', 'typing', 'enum',
        'logging', 'warnings', 'copy', 'pprint', 'ast', 'dis', 'inspect',
    })
...
class AliasTracker:
    ...
    def resolve(self, call: str) -> Optional[str]:
...
class CallResolver:
    ...
    def resolve_call_site(self, call_site: str, source_file: Optional[str] = None) -> Tuple[str, str, float]:
