...
def _bootloader_template() -> str:
    ...
    return (
        ...
        "## \U0001f6ab HARD PROHIBITIONS (NON-NEGOTIABLE)\n"
        ...
        "- NEVER call internal runtime nodes directly.\n\n"
        "If you feel the urge to do any of the above -> STOP -> call `kit doctor` first.\n\n"
        "## \U0001f9e0 MEMORY ACCESS CONTRACT\n"
        "ALL memory operations MUST go through exactly one of these three gates:\n"
        "  kit recall       -> Reading context / knowledge\n"
        "  kit search       -> Locating a specific symbol/topic\n"
        "  kit introspect   -> Inspecting schema/command registry\n\n"
        "## \U0001f3af ROUTING\n"
