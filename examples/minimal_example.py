...
from kit.api import init_kernel, learn, link, recall
...
def run_e2e_verification():
    ...
    _f2 = learn(content="Dùng để lưu trữ session và blacklist tokens.", uid="Redis", kind="Storage")

    # Supersede f1 with a more important fact
    _f3 = learn(
        content="CẬP NHẬT: Chuyển sang RS256 để hỗ trợ Key Rotation.",
        uid="AuthService",
        kind="Component",
        importance=1.0,
        supersede_id=f1,
